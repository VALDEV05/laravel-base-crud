    ...
    <div id="topnav" class="d-flex align-items-center">
        <div class="container">
            <nav class="nav justify-content-end">
                <a class="text-decoration-none text-uppercase fw-bold me-5 d-flex align-items-center" href="{{route('admin.dashboard')}}">Admin <i class="ms-2 fas fa-user-shield"></i></a>
